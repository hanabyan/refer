...
// use Restserver\Libraries\REST_Controller_Definitions as REST_Definitions;
...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        if ($this->is_guarded)
        {
            $profile = $this->verify_auth();
            $this->subject_id = $profile->sub;
        }
    }
    ...
    protected function verify_auth()
    {
        ...
        {
            $this->set_response('Authorization header not found', self::HTTP_BAD_REQUEST, false);
        }
    ...
    protected function _isExists($val, $arr)
    {
